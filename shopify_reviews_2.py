...
Original file is located at
    https://colab.research.google.com/drive/1OSakCyjMLbBmM5BA4hk1w5gJMOmKnXRt
"""
...
def main():
    ...
    for input_url in base_urls:
        ...
        if all_collected_reviews_for_url:
            ...
            if COLAB_ENV:
                save_path = f'/content/drive/MyDrive/Shopify Reviews/{file_name}'
                # Ensure the directory exists if running in Colab
                import os
                os.makedirs('/content/drive/MyDrive/Shopify Reviews', exist_ok=True)
            else:
                save_path = file_name # Save in current directory if not Colab
